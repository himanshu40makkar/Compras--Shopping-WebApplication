...
<div style="padding:10%">
<input type="checkbox" name="category" value="shirt">Shirts<br/>
<input type="checkbox" name="category" value="tshirt">T-shirts<br/>
<input type="checkbox" name="category" value="trouser">Trousers<br/>
</div>
